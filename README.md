...
Проект предоставляет возможности для:
- Автоматического обнаружения кластеров 1С (LLD - Low Level Discovery)
- Сбора метрик сессий и фоновых заданий
- Мониторинга информационных баз
- Проверки доступности RAS (Remote Administration Service)
- Интеграции с Zabbix через UserParameter
...
- ✅ REST API на FastAPI (опционально)
